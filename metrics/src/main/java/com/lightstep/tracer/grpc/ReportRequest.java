...
private static final long serialVersionUID = 0L;
  ...
  /**
   * <code>int64 timestamp_offset_micros = 5 [jstype = JS_STRING];</code>
   */
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getTimestampOffsetMicros()
        != other.getTimestampOffsetMicros()) return false;
    if (hasInternalMetrics() != other.hasInternalMetrics()) return false;
    if (hasInternalMetrics()) {
      if (!getInternalMetrics()
          .equals(other.getInternalMetrics())) return false;
    }
