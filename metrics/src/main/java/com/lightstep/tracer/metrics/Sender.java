...
abstract class Sender<I,O> {
  ...
  abstract O run(MetricGroup[] metricGroups, long timeout) throws Exception;
  ...
  final I newSampleRequest(final MetricGroup[] metricGroups, final I request) throws IOException {
